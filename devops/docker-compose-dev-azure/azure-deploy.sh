...
resourcename="woodinventorymanagement"  # lower case, only
resourcegroup="woodinventorymanagement_rg"
...
# git clone https://github.com/apilogicserver/woodinventorymanagement.git
# cd woodinventorymanagement
...
az group create --name woodinventorymanagement_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group woodinventorymanagement_rg --sku S1 --is-linux
az container create --resource-group woodinventorymanagement_rg --name woodinventorymanagement --image apilogicserver/woodinventorymanagement:latest --dns-name-label woodinventorymanagement --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//woodinventorymanagement.westus.azurecontainer.io:5656'
