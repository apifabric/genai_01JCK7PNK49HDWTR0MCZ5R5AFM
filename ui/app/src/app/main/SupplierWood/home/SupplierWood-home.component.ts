...
@Component({
  selector: 'SupplierWood-home',
  templateUrl: './SupplierWood-home.component.html',
  styleUrls: ['./SupplierWood-home.component.scss']
})
export class SupplierWoodHomeComponent implements AfterViewInit {
